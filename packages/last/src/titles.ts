...
export const TITLES = {
  ...
  object: {
    ...
    effectParamAngle: 'effect-param-angle',
    effectParamCheckbox: 'effect-param-checkbox',
    effectParamColor: 'effect-param-color',
    effectParamDropdown: 'effect-param-dropdown',
    effectParamIgnored: 'effect-param-ignored',
    effectParamLayer: 'effect-param-layer',
    effectParamNoValue: 'effect-param-no-value',
  ...
  array: {
    ...
    assetsChildren: 'assets-children',
    compositionChildren: 'composition-children',
    effectListChildren: 'effect-list-children',
    effectParamListChildren: 'effect-param-list-children',
    extraCompositionsChildren: 'extra-compositions-children',
    bezierInTangentsChildren: 'bezier-in-tangents-children',
    keyframeEndValueChildren: 'keyframe-end-value-children',
    keyframeListChildren: 'keyframe-list-children',
    keyframeValueChildren: 'keyframe-value-children',
    keywordsChildren: 'keywords-children',
    layerStyleChildren: 'layer-style-children',
    layerStyleListChildren: 'layer-style-list-children',
    markersChildren: 'markers-children',
    masksPropertiesChildren: 'masks-properties-children',
    bezierOutTangentsChildren: 'bezier-out-tangents-children',
    positionKeyframeListChildren: 'position-keyframe-list-children',
    shapeKeyframeListChildren: 'shape-keyframe-list-children',
    shapeKeyframeStartChildren: 'shape-keyframe-start-children',
    shapeListChildren: 'shape-list-children',
    staticValuesChildren: 'static-values-children',
    strokeDashListChildren: 'stroke-dash-list-children',
    textRangesChildren: 'text-ranges-children',
    textCharactersChildren: 'text-characters-children',
    textDocumentKeyframesChildren: 'text-document-keyframes-children',
    textFontListChildren: 'text-font-list-children',
    positionKeyframeInTangentsChildren: 'position-keyframe-in-tangents-children',
    positionKeyframeOutTangentsChildren: 'position-keyframe-out-tangents-children',
    bezierVerticesChildren: 'bezier-vertices-children',
    bezierXAxisChildren: 'bezier-x-axis-children',
    bezierYAxisChildren: 'bezier-y-axis-children',
    colorRgbaChildren: 'color-rgba-children',
    ...
    // start temporary titles
    composition: 'composition',
    effectList: 'effect-list',
    effectParamList: 'effect-param-list',
